...
export const BLOG_ARTICLES = [
  {
    ...
    image: "/images/blog/ChatGPT_Image_May_25_2026_02_29_41_PM.png",
    imageAlt:
      "High school students collaborating on a meaningful community summer project in India",
    sections: [
      {
        id: "section-1",
        ...
        paragraphs: [
          ...
          "In short: We are not predicting admission outcomes - we are translating public guidance into practical summer planning you can defend in an essay or interview.",
        ],
      },
      {
        id: "section-2",
        heading: "What has shifted in selective admissions",
        paragraphs: [
          "A few changes are worth naming before you optimise a summer schedule:",
        ],
        list: [
      ...
      {
        id: "section-3",
        heading: "What universities say they value (public guidance)",
        paragraphs: [
      ...
      {
        id: "section-4",
        heading: "Shapes of summer projects that tend to yield strong stories",
        paragraphs: [
          "Most impactful summers resemble one of a handful of repeatable patterns:",
        ],
        list: [
        ...
        subsections: [
          {
            subheading: "Patterns That Tend to Yield Thinner Essays",
            list: [
      ...
      {
        id: "section-6",
        heading: "Documentation: why it matters",
        paragraphs: [
          ...
          "In short: Demand certificates only from credible, registered NGOs whose language matches delivered work. Oversold credentials can undermine trust.",
        ],
      },
      {
        id: "section-7",
        heading: "How The Giving Circle can help structure the summer",
        paragraphs: [
      ...
      {
        id: "section-8",
        heading: "A sensible week-by-week plan",
        paragraphs: [
          "A reasonable timeline for families beginning in late spring:",
        ],
        list: [
        ...
        subsections: [
          {
            subheading: "Continuing Your Reading Journey",
            paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Common questions from students and parents planning their summer extracurriculars:",
        ],
        faqs: [
          {
            question:
              "Will volunteering once through The Giving Circle guarantee admission overseas?",
            answer:
              "No. Admissions outcomes depend on many factors including academics, intellectual vitality, personal essays, and institutional priorities. Participation in programmes - ours or elsewhere - never guarantees admission to any individual institution. What a structured programme provides is verifiable, accountable evidence and sustained responsibility that your child can speak and write about with conviction.",
          },
          {
            question:
              "Should my child chase breadth or rack up ten different NGO logos?",
            answer:
              "No. Selective universities consistently signal that depth beats breadth. Stacking ultra-short bursts across unrelated organisations often looks assembled rather than lived. Admissions officers look for sustained effort (such as 8-10 weeks with 6 hours weekly) in one or two focused areas where the student developed real understanding after the novelty wore off.",
          },
          {
            question: "What should a certificate prove?",
            answer:
              "A certificate should prove actual throughput and verified contributions, not mere attendance or vanity hours. It should come from a credible, registered NGO, clearly describe the student's responsibilities, hours completed, and the tangible outcome or deliverables achieved on the ground.",
          },
          {
            question: "Is fundraising a legitimate summer storyline?",
            answer:
              "Yes, when done with receipts and accountability. Raising funds for a verified cause, document every rupee, and publish transparently what changed for the beneficiaries teaches real stewardship, project management, and stakeholder communication.",
          },
        ],
      },
    ],
    relatedLinks: [
      ...
      },
      {
        ...
        href: "/blog/how-to-donate-for-child-education-in-india-80g",
      },
      {
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT_Image_Jun_25_2026_12_06_46_PM.png",
    imageAlt:
      "High school student reflecting on community service and college applications in India",
    sections: [
      {
        id: "section-1",
      ...
      },
      {
        ...
        heading: "Frequently asked questions",
        paragraphs: [
          "Common questions families ask about community service and university admissions abroad.",
        ],
        faqs: [
          {
            question:
              "Does community service guarantee admission to US or UK universities?",
            answer:
              "No. Admissions outcomes depend on many factors beyond extracurricular involvement, and The Giving Circle does not represent that participating in any volunteer programme guarantees or improves admission to any specific institution. What selective universities value is intellectual vitality, sustained commitment, and evidence that the student cared about outcomes beyond themselves.",
          },
          {
            question:
              "How many volunteer activities should my child list on the Common App?",
            answer:
              "Selective admissions readers consistently emphasize depth over breadth. Stacking numerous short, unrelated volunteer stints across one or two summers tends to read as assembled rather than lived. Admissions officers look for one or two focused threads sustained over time where the student made a tangible, verified contribution.",
          },
          {
          ...
          {
            question:
              "When should we start planning community service for college applications?",
            answer:
              "Starting in Class 9 or 10 allows a student to carry a sustained thread across at least two summers and the school year between them. Deepening involvement over multiple years is difficult to manufacture in the summer before Class 12, but much more natural when begun early.",
          },
        ],
      },
    ],
    relatedLinks: [
      {
        title:
          "Meaningful Summer Projects for High School Students in India →",
      ...
      {
        title: "Wings of Hope · menstrual health education →",
        href: "/causes/wings-of-hope",
      },
      {
        title: "Volunteer Opportunities (Delhi focus) →",
        href: "/volunteer",
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT_Image_May_25_2026_02_32_22_PM.png",
    imageAlt:
      "Children studying in a classroom in India, supported by child education giving",
    sections: [
      {
        id: "section-1",
        ...
        paragraphs: [
          ...
          "Recent government initiatives, including the continued emphasis on the National Education Policy 2020 and the 'Padhe India, Badhe India' mission, aim to enhance educational access and reduce dropout rates.",
          "In line with this, the government's education spending allocation for FY 2026 has risen to ₹93,000 crores, directly reinforcing initiatives in child education.",
          "In short: Goal-focused giving is more effective than one-time donations without follow-up or transparency.",
        ],
      },
      {
        id: "section-2",
        ...
        paragraphs: [
          "Here’s a simple process to donate for child education in India with clarity and confidence:",
        ],
        list: [
          "Pick the cause: choose 'education' and ensure the NGO works with children in a defined geography.",
          "Choose your giving amount: consider starting with a small recurring contribution for consistent education support.",
          "Donate through The Giving Circle: your donation flows to verified education causes.",
          "Track impact: receive updates and visibility into how the funds support beneficiaries.",
          "Get your 80G receipt (for eligible donations): use it for tax deductions, according to Indian tax rules.",
        ],
      },
      {
        id: "section-3",
        ...
        paragraphs: [
          "In India, eligible donations under Section 80G can qualify for tax deductions. Currently, 50% of contributions are deductible for donations made to registered NGOs specializing in child education.",
          "Donations directed towards NGOs that specialize in child education continue to qualify for these deductions.",
          "Documentation must meet specific requirements for 80G eligibility. Always confirm your eligibility for each case and consult a qualified tax professional if needed.",
        ],
      },
      {
        id: "section-4",
      ...
      },
      {
        ...
        list: [
          "Donating without verifying if the NGO supports education outcomes (not just administrative costs).",
          "Choosing solely based on 'claims' without evidence of transparency or reporting.",
          "Making a one-time donation when recurring support is crucial for keeping children in school.",
        ],
      },
      {
        id: "section-6",
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Common questions about donating for child education and claiming 80G tax deductions in India.",
        ],
        faqs: [
          {
            question: "How do I donate for child education in India?",
            answer:
              "You can donate directly through verified platforms like The Giving Circle. Choose an education campaign, select your contribution amount (one-time or recurring), complete the secure payment, and receive verified updates on how your funds help keep children in classrooms.",
          },
          {
            question:
              "What is the current percentage of out-of-school children in India?",
            answer:
              "As of mid-2026, approximately 13% of children aged 6-14 remain out of school. While enrollment has improved, targeted community support and bridge programs remain essential to bring children into formal education.",
          },
          {
            question:
              "Do donations for education qualify for 80G tax benefits?",
            answer:
              "Yes, eligible donations to registered NGOs with active 80G certification qualify for up to a 50% tax deduction under Section 80G of the Indian Income Tax Act. Always ensure you receive a formal 80G receipt with the NGO's PAN and registration details.",
          },
          {
            question:
              "What recent government initiatives are aimed at improving child education in India?",
            answer:
              "Key initiatives include the continued implementation of the National Education Policy (NEP 2020), the 'Padhe India, Badhe India' mission for foundational literacy, and an increased budget allocation of ₹93,000 crores for FY 2026 aimed at reducing dropout rates.",
          },
          {
            question:
              "What are the expected trends in education funding in 2026?",
            answer:
              "In 2026, giving trends increasingly emphasize transparent, outcomes-based funding and recurring support rather than ad-hoc donations, with digital giving circles making collective impact measurable and accountable.",
          },
        ],
      },
    ],
    relatedLinks: [
      {
        title: "Donate for Education India →",
        href: "/causes/pehli-class",
      },
      {
        title: "Verified NGOs Directory →",
        href: "/causes",
      },
      {
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT_Image_May_25_2026_02_37_47_PM.png",
    imageAlt:
      "NGO leaders and community volunteers collaborating on transparent social impact in Delhi",
    sections: [
      {
        id: "section-1",
        heading: "What “verified” means",
        paragraphs: [
          "The term “verified” ensures that the NGO or cause partner has undergone thorough documentation and transparency reviews, guiding you on how your contributions are utilized.",
          "Rather than solely trusting announcements, we encourage donors to seek evidence of structured operations and clear reporting.",
          "In short: Verification empowers you to donate confidently by emphasizing transparency over mere claims.",
        ],
      },
      {
        id: "section-2",
        heading: "Transparency signals to check",
        paragraphs: [
          "Before making a donation to an NGO in Delhi, look for these transparency signals:",
        ],
        list: [
          "Clear beneficiary focus (who the program serves and its operational area)",
          "Regular updates that detail outcomes rather than just fundraising appeals",
          "Utilization or impact reports that demonstrate progress over time",
          "How the organization communicates and addresses inquiries",
        ],
      },
      {
        id: "section-3",
        ...
        paragraphs: [
          "Effective updates should help you answer the question: “What changed because of this donation?”",
          "Seek details such as activity summaries, measurable progress, timelines, and, where possible, evidence of learning, attendance, or service delivery.",
        ],
        list: [
          "A timeline of activities (what occurred and when)",
          "High-level explanations of program costs",
          "Impact summaries that are straightforward to understand",
        ],
      },
      {
        id: "section-4",
        ...
        paragraphs: [
          "Visit our Verified NGOs in Delhi page to explore trustworthy options.",
          "Select the causes you wish to support and choose a donation method that allows you to track outcomes (for example, recurring donations).",
          "Start by exploring live verified causes, whether you are championing child education, menstrual hygiene, or community animal welfare across Delhi NCR.",
          "In short: Recurring support often facilitates a clearer view of evolving outcomes.",
        ],
      },
      {
        id: "section-5",
        heading: "Frequently asked questions",
        paragraphs: [
          "Common questions about finding, evaluating, and donating to verified NGOs in Delhi.",
        ],
        faqs: [
          {
            question: "Are all NGOs on the platform verified?",
            answer:
              "Yes. Every NGO featured on The Giving Circle undergoes thorough verification of its legal status, 80G certification, operational history, and reporting transparency before any cause is launched.",
          },
          {
            question: "Does my donation qualify for 80G?",
            answer:
              "Yes, contributions to eligible verified NGOs on our platform qualify for tax deduction under Section 80G of the Indian Income Tax Act. You will receive an official tax receipt with the NGO's registration details.",
          },
          {
            question: "How often will I get updates?",
            answer:
              "Donors and Cause Champions receive regular milestone updates and progress reporting directly from the ground, showing measurable results and transparent utilization of funds.",
          },
          {
            question:
              "What recent trends are influencing NGO donations in India?",
            answer:
              "Donors in 2026 increasingly prioritize outcome-based accountability, multi-year recurring giving, and collective giving circles where friends and families pool funds for greater impact rather than making isolated, untracked contributions.",
          },
          {
            question:
              "What are the latest government initiatives regarding NGOs?",
            answer:
              "Recent regulatory guidelines in India emphasize streamlined digital compliance, stricter annual returns, and transparent online verification via portal registries to protect donor trust and ensure non-profit accountability.",
          },
          {
            question: "What factors should I consider when choosing an NGO?",
            answer:
              "Look for documented legal registration (12A/80G), transparent audited financial accounts, clear evidence of ground impact, responsiveness to donor inquiries, and a defined geographical and community focus.",
          },
        ],
      },
    ],
    relatedLinks: [
      ...
      {
        title: "NGO Registration Verification Guide India (2026) →",
        href: "/about",
      },
      {
        title:
          "India Philanthropy Report 2026: Strengthening Philanthropy Infrastructure →",
        href: "/blog",
      },
    ],
  },
  {
    ...
    image: "/images/blog/ChatGPT_Image_May_25_2026_02_40_10_PM.png",
    imageAlt:
      "Corporate team evaluating CSR social impact and NGO partnerships in India",
    sections: [
      {
        id: "section-1",
        heading: "What CSR Means (High-Level)",
        paragraphs: [
          "Corporate Social Responsibility (CSR) refers to the initiatives companies undertake to contribute positively to society, encompassing areas like education, healthcare, and community development.",
          "A robust CSR program typically includes a clear problem statement, defined beneficiaries, a funded plan, and ongoing monitoring with reporting.",
        ],
      },
      {
        id: "section-2",
        heading: "How CSR Projects Get Funded: Step-by-Step",
        paragraphs: ["A practical process companies can follow:"],
        list: [
      ...
      {
        id: "section-3",
        heading: "Choosing a Verified Partner",
        paragraphs: [
          "Select partners based on clarity, documentation, and reporting capability.",
          ...
          "In short: Prioritize organizations that communicate outcomes clearly and consistently.",
        ],
      },
      {
        id: "section-4",
      ...
      {
        id: "section-5",
        heading: "Recent Policy Changes Affecting CSR in India",
        paragraphs: [
          "The Corporate Laws (Amendment) Bill, 2026, has significantly altered CSR norms, raising the net profit threshold for mandatory CSR spending from ₹5 crore to ₹10 crore. Additionally, the timeframe for transferring unspent CSR funds to a separate account has been extended from 30 to 90 days, which aims to alleviate compliance burdens and foster strategic CSR investments.",
          "The Union Budget 2026 emphasizes enhanced public-private collaboration and scalable interventions, showcasing the government's dedication to boosting CSR effectiveness.",
          "As of mid-2026, corporate spending on CSR is projected to reach ₹45,000 crore, reflecting a notable increase in corporate commitment to social responsibilities.",
          "Technological advancements, such as AI and blockchain, are being leveraged to enhance transparency and accountability in CSR initiatives.",
        ],
      },
      {
        id: "section-6",
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Common questions from corporate teams, CSR committees, and company leaders planning CSR programs in India.",
        ],
        faqs: [
          {
            question:
              "Can my company fund CSR projects in India through The Giving Circle?",
            answer:
              "Yes. The Giving Circle connects corporate teams and giving circles with verified grassroots NGOs across priority sectors such as education, women's health, disaster relief, and animal welfare, providing structured reporting and transparent fund allocation.",
          },
          {
            question:
              "What are the recent changes in CSR compliance for companies?",
            answer:
              "Recent updates through the Corporate Laws (Amendment) Bill, 2026, have raised the mandatory CSR net profit threshold from ₹5 crore to ₹10 crore, and extended the window to transfer unspent funds to an unspent CSR account from 30 to 90 days, easing operational compliance.",
          },
          {
            question: "What is the projected growth of CSR spending in 2026?",
            answer:
              "As of mid-2026, corporate CSR expenditure across India is projected to reach approximately ₹45,000 crore, driven by larger corporate allocations and greater strategic focus on long-term, scalable community outcomes.",
          },
          {
            question: "How is technology influencing CSR initiatives in India?",
            answer:
              "Companies are increasingly utilizing AI for impact forecasting, digital verification registries for NGO due diligence, and automated milestone tracking to provide stakeholders with real-time visibility into project delivery.",
          },
          {
            question: "What role does the government play in CSR trends?",
            answer:
              "Through policy updates in Union Budget 2026 and initiatives like the National CSR Portal, the government encourages public-private partnerships, outcome-based monitoring, and alignment with national development priorities.",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          "Browse verified causes at thegivingcircle.in/causes",
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Common questions about what defines a philanthropist and how collective giving works in India.",
        ],
        faqs: [
          {
            question:
              "Is Section 80G the same as calling yourself a philanthropist?",
            answer:
              "No. Section 80G is simply a provision under the Indian Income Tax Act that offers deductions for donations to eligible institutions. Being a philanthropist is about your intentionality, values, and consistent commitment to social impact, whether you claim the tax deduction or not.",
          },
          {
            question:
          ...
          },
          {
            ...
            answer:
              "Absolutely. When you give ₹200 to ₹500 monthly or start a giving circle with friends to collectively fund a classroom or animal shelter, you are practicing active philanthropy. Predictable, recurring support is often far more valuable to grassroots NGOs than irregular windfalls.",
          },
          {
            question: "What is a giving circle in simple terms?",
            answer:
              "A giving circle is a collaborative giving model where everyday individuals pool their personal donations together, decide which verified cause to support, and track the impact of their shared contribution as a community.",
          },
          {
            question:
              "Are donations to giving circles tax deductible in India?",
            answer:
              "Yes, when contributions flow directly to verified NGO partners that hold active Section 80G certification under Indian income tax law, eligible donors receive formal 80G receipts for tax deductions.",
          },
        ],
      },
    ],
    relatedLinks: [
      ...
      {
        title: "Brick by Brick · Animal Care Gurgaon shelter →",
        href: "/causes/brick-by-brick",
      },
      {
        title: "Verified NGO list (India) →",
        href: "/causes",
      },
      {
        title: "Verified NGOs hub →",
        href: "/blog/verified-ngos-in-delhi",
      },
    ],
  },
  {
    ...
    image: "/images/blog/ChatGPT_Image_May_25_2026_02_44_16_PM.png",
    imageAlt:
      "Volunteers and community members participating in collective philanthropy in India",
    sections: [
      {
        id: "section-1",
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Common questions about philanthropy, collective giving, and 80G tax deductions in India.",
        ],
        faqs: [
          {
            question: "What is the simplest definition of philanthropy?",
            answer:
              "Philanthropy is voluntary action, giving, or service aimed at creating systemic, lasting positive change for the public good, rather than merely offering short-term relief.",
          },
          {
            question: "Is philanthropy only for rich people in India?",
            answer:
              "No. Everyday citizens practicing monthly giving or pooling donations through community giving circles are active philanthropists. Predictable, collective contributions of ₹500/month often provide grassroots NGOs with greater stability than occasional large gifts.",
          },
          {
            question:
              "What is the difference between philanthropy and CSR in India?",
            answer:
              "Philanthropy encompasses all voluntary giving by individuals, families, and foundations. CSR refers specifically to the legally mandated 2% net-profit social expenditure required of eligible companies under Section 135 of the Indian Companies Act.",
          },
          {
            question: "Is Section 80G the same as being philanthropic?",
            answer:
              "No. Section 80G is an income tax provision enabling deductions on eligible charitable donations. Philanthropy is the intentional mindset and action of supporting social betterment; 80G is a regulatory incentive.",
          },
          {
            question:
              "How does The Giving Circle support philanthropy in India?",
            answer:
              "The Giving Circle connects Cause Champions and donors with verified grassroots NGOs, simplifies recurring giving, facilitates collective giving circles, and ensures quarterly outcome reports and 80G tax receipts.",
          },
        ],
      },
    ],
    relatedLinks: [
      ...
      {
        title: "What is a Philanthropist? →",
        href: "/blog/what-is-a-philanthropist-india",
      },
      {
        title: "Verified NGO list (India) →",
        href: "/causes",
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT_Image_May_25_2026_03_02_12_PM.png",
    imageAlt:
      "Guide on how to donate to verified NGOs in India with 80G receipts and accountability",
    sections: [
      {
        id: "section-1",
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Common questions about donating safely to NGOs in India, verifying registrations, and claiming 80G tax benefits.",
        ],
        faqs: [
          {
            question: "How do I find verified NGOs to donate to in India?",
            answer:
              "Look for organizations listed on platforms with rigorous due diligence like The Giving Circle. Verify their active 80G and 12A registrations on the Income Tax portal, check FCRA records on mha.gov.in if donating from abroad, and review recent audited annual financial reports.",
          },
          {
            question: "Is my donation to an NGO in India tax deductible?",
            answer:
              "Yes, donations made to NGOs with valid Section 80G registration are eligible for up to a 50% tax deduction under the Indian Income Tax Act. Ensure you receive an official stamped receipt containing both your PAN and the NGO's 80G registration number.",
          },
          {
            question: "What is FCRA registration and why does it matter?",
            answer:
              "FCRA (Foreign Contribution Regulation Act) registration is granted by the Ministry of Home Affairs, permitting an Indian NGO to legally receive foreign donations. It represents a stringent level of government oversight and financial compliance.",
          },
          {
            question: "Can I donate online to NGOs in India safely?",
            answer:
              "Yes, provided you use verified platforms with encrypted payment gateways, direct NGO disbursement, and instant receipt generation. Avoid unsecured direct bank transfers or UPI handles circulated on social media without verifiable institutional receipts.",
          },
        ],
      },
    ],
    relatedLinks: [
      ...
      {
        title: "How to Donate for Child Education India →",
        href: "/blog/how-to-donate-for-child-education-in-india-80g",
      },
      {
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT_Image_May_25_2026_03_04_17_PM.png",
    imageAlt:
      "How to donate for women empowerment in India: verified NGOs, tax benefits and impact",
    sections: [
      {
        id: "section-1",
        ...
        paragraphs: [
          ...
          "In short: Women's empowerment is not a charity issue. It is an economic and social multiplier.",
        ],
      },
      {
        id: "section-2",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "In short: Your women empowerment donation saves you tax and changes lives. Claim your 80G deduction.",
        ],
      },
      {
        id: "section-5",
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Common questions about donating to women empowerment initiatives, vetting NGOs, and claiming tax benefits in India.",
        ],
        faqs: [
          {
            question: "Which are the best NGOs for women empowerment in India?",
            answer:
              "Leading verified organizations include Joint Women's Programme (JWP), SEWA, and other grassroots non-profits registered with valid 80G and 12A certifications. Look for NGOs that publish clear beneficiary numbers, audited accounts, and regular outcome reports.",
          },
          {
            question: "Is my donation for women empowerment tax deductible?",
            answer:
              "Yes, donations made to registered Indian NGOs holding Section 80G certification qualify for a 50% tax deduction under the Income Tax Act. A formal stamped receipt with the NGO's PAN, registration number, and your PAN is provided upon donation.",
          },
          {
            question: "How do I know my women empowerment donation is being used well?",
            answer:
              "Choose platforms that conduct independent audits and track measurable indicators like school completion rates, vocational certifications, or micro-enterprise launches. Look for periodic photo and field updates from the NGO.",
          },
          {
            question: "Can companies fund women empowerment as a CSR project in India?",
            answer:
              "Yes. Promoting gender equality, empowering women, and setting up homes or hostels for women and orphans are expressly listed under Schedule VII of the Companies Act, 2013 as qualifying CSR activities.",
          },
        ],
      },
    ],
    relatedLinks: [
      {
        title: "NGO for Women Empowerment India →",
        href: "/causes/wings-of-hope",
      },
      {
        title: "#PehliClass · donate for education India →",
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT Image Jun 25, 2026, 12_01_27 PM.png",
    imageAlt:
      "CAS, Duke of Edinburgh, and verified volunteer certificates guide for Indian students",
    sections: [
      {
        id: "section-1",
        ...
        paragraphs: [
          ...
          "In short: The specific hour requirements and timelines change occasionally. Check the official sources before relying on any number you see online, including in this post.",
        ],
      },
      {
        id: "section-2",
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Common questions from students and parents regarding CAS hours, DofE assessor sign-offs, and service verification.",
        ],
        faqs: [
          {
            question: "Does a certificate from The Giving Circle count as CAS evidence?",
            answer:
              "Yes, provided your school's CAS coordinator approves the activity proposal beforehand. Because TGC partners with registered NGOs and provides a named supervisor, detailed hour logs, and clear reflections, students can fulfill IB CAS learning outcomes with verifiable proof.",
          },
          {
            question: "What documentation should I bring to my CAS coordinator?",
            answer:
              "Bring a completed activity plan with learning outcomes mapped, weekly timestamped hour logs signed by the NGO project supervisor, photo evidence of completed fieldwork or workshops, and the formal certificate of completion.",
          },
          {
            question: "How do I verify that an NGO is legitimate for DofE purposes?",
            answer:
              "Check that the non-profit is officially registered (e.g., under NGO Darpan or Registrar of Societies), has a non-family assessor willing to write the final assessor report, and has operated verifiable on-ground programmes with clear community impact.",
          },
          {
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT Image Jun 25, 2026, 12_01_48 PM.png",
    imageAlt:
      "Five volunteer project ideas for Indian students across education, hunger, and animal welfare",
    sections: [
      {
        id: "section-1",
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Practical guidance on selecting a volunteer project, balancing time, and completing school service requirements.",
        ],
        faqs: [
          {
            question: "How do I pick one cause if more than one interests me?",
            answer:
              "Select the one where you can commit consistently for 4 to 8 weeks rather than trying to split your time across multiple causes. Deep engagement with measurable outputs in one cause always produces more meaningful learning and documentation than superficial hours across many.",
          },
          {
            question: "How many hours a week do these projects require?",
            answer:
              "Most student projects take between 4 to 8 hours per week, typically structured around one or two weekend field sessions or dedicated weekday afternoon workshop planning.",
          },
          {
            question: "Can I do these projects remotely?",
            answer:
              "Yes, aspects such as building donor tracking sheets, designing multilingual learning cards, conducting curriculum research, or producing video lessons can be completed remotely in coordination with the partner NGO.",
          },
          {
            question: "Do these project ideas count for CAS or DofE service hours?",
            answer:
              "Yes. When arranged through a verified non-profit partner with a designated supervisor, clear weekly goals, and documented reflections, these projects directly satisfy CAS service strands and DofE volunteer criteria.",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    image: "/images/blog/ChatGPT Image Jun 25, 2026, 12_02_00 PM.png",
    imageAlt:
      "A parent's guide to a meaningful summer for teenagers in India: service, balance, and university readiness",
    sections: [
      {
        id: "section-1",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "In short: In September, ask them to write three pages about what they noticed. Save those pages. They become the spine of the eventual application essay.",
        ],
        list: [
      ...
      },
      {
        ...
        heading: "Frequently Asked Questions",
        paragraphs: [
          "Answers to common dilemmas parents face when helping high schoolers plan constructive, authentic summer engagement.",
        ],
        faqs: [
          {
            question: "My child is not motivated to plan this. What do I do?",
            answer:
              "Start with what genuinely frustrates or interests them in daily life rather than imposing an academic extracurricular requirement. Give them agency to choose the cause, schedule their own calls with the NGO coordinator, and set their own goals.",
          },
          {
            question: "How much should a meaningful summer cost?",
            answer:
              "Real community service and authentic student projects with verified non-profits should cost little to nothing. Be wary of commercial programmes charging exorbitant fees solely to issue an international certificate.",
          },
          {
            question: "My child is starting Class 12. Is it too late to make this count?",
            answer:
              "No. A single 6 to 8 week summer engagement in early Class 12 with deep focus, an accountable non-profit, and concrete output can provide the primary personal narrative for college supplemental essays and interviews.",
          },
          {
            question: "Should I manage the summer, or let my child lead?",
            answer:
              "Provide structural scaffolding (safety, transport, schedule boundaries) but let the student own day-to-day coordination and delivery. Admissions committees and interviewers quickly sense when a teenager is reciting parent-directed activities versus describing genuine personal ownership.",
          },
        ],
      },
    ],
