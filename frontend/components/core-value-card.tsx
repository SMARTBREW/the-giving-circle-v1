...
function ValueIconMark({ icon }: { icon: ValueIcon }) {
  ...
  return (
    <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[var(--Eyebrow-label,#00A98F)] bg-[#FFFFFF] transition-all duration-300 group-hover:scale-105 group-hover:bg-[#00A98F]/10 sm:h-12 sm:w-12 min-[90rem]:h-14 min-[90rem]:w-14">
      <IconComponent
        className="h-5 w-5 text-[var(--Eyebrow-label,#00A98F)] sm:h-6 sm:w-6 min-[90rem]:h-7 min-[90rem]:w-7"
        strokeWidth={2}
        aria-hidden="true"
      />
    </span>
...
export default function CoreValueCard({
  ...
  return (
    <li className="group flex h-full w-full flex-col items-center rounded-[1rem] border border-[#BDBDBD] bg-[#FFFFFF] px-5 py-5 shadow-[0px_4px_20px_0px_#0000000F] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0px_8px_30px_0px_rgba(0,0,0,0.08)] sm:px-6 sm:py-6 md:px-7 md:py-7 min-[90rem]:px-8 min-[90rem]:py-8">
