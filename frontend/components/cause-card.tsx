...
export default function CauseCard({
  ...
  return (
    <li className="group relative aspect-[4/3] w-full overflow-hidden rounded-[1rem] border border-[#BDBDBD] md:aspect-[4/5] md:w-[calc(50%-0.625rem)] min-[90rem]:aspect-auto min-[90rem]:h-[21.75rem] min-[90rem]:min-w-0 min-[90rem]:flex-1 min-[90rem]:w-auto">
