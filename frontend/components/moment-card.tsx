  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3
          className={`${SEGOE_UI_CLASS} relative z-10 mt-4 text-center text-[1.375rem] leading-none font-[700] tracking-normal text-[var(--Dark-Charcoal,#1c2426)] sm:mt-5 sm:text-[1.5rem] min-[70rem]:mt-4 min-[70rem]:text-[1.375rem] min-[90rem]:mt-5 min-[90rem]:text-[1.75rem]`}
        >
          {title}
        </h3>
        <p
        ...
        <div className="relative z-10 mt-6 w-full min-w-0 sm:mt-7 min-[70rem]:mt-auto min-[70rem]:pt-5 min-[90rem]:mt-auto min-[90rem]:pt-6">
          <CtaButton
            href={href}
            variant="outline"
            hoverFill
            className="h-12 w-full max-w-full shrink-0 bg-[#FFFFFF] px-2.5 py-3 text-[0.8125rem] sm:h-14 sm:px-4 sm:text-[1rem] min-[70rem]:h-14 min-[70rem]:px-3 min-[70rem]:text-[1rem] min-[90rem]:h-[4rem] min-[90rem]:px-6 min-[90rem]:py-5 min-[90rem]:text-[1.125rem]"
            labelClassName="max-w-full shrink-0 !whitespace-nowrap"
          >
            {ctaLabel}
