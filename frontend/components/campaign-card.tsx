  ...
  return (
    <article className="flex h-full w-full flex-col overflow-hidden rounded-[1rem] border border-[#BDBDBD] bg-[#FFFFFF] shadow-[0px_4px_20px_0px_#0000000F] transition-transform duration-300 ease-out hover:-translate-y-1 min-[90rem]:h-[39.0625rem] min-[90rem]:w-full">
      ...
      <div className="flex flex-1 flex-col gap-3 px-4 pt-4 pb-4 sm:gap-3.5 sm:px-5 sm:pt-5 sm:pb-5 min-[90rem]:gap-4 min-[90rem]:px-6 min-[90rem]:pt-5 min-[90rem]:pb-6">
        ...
        <div
          className={`${SEGOE_UI_CLASS} flex flex-wrap items-center justify-between gap-x-3 gap-y-1 text-[0.875rem] leading-none tracking-normal text-[var(--Subheading,#45564B)] min-[90rem]:text-[1rem]`}
        >
          <span>
        ...
        <div className="mt-auto flex flex-col gap-3">
          ...
          <div
            className={`${SEGOE_UI_CLASS} flex flex-wrap items-center justify-between gap-x-3 gap-y-1 text-[0.875rem] font-[400] leading-none tracking-normal text-[#404943] min-[90rem]:text-[1rem]`}
          >
