...
export default function CauseFundingCard({
  ...
  return (
    <motion.div
      ...
      className="relative flex h-full flex-col justify-between overflow-hidden rounded-[1rem] border border-[#BDBDBD] bg-[#FFFFFF] p-5 sm:rounded-[1.25rem] sm:p-6 min-[90rem]:p-8"
    >
      <div>
        <div
          aria-hidden
          className="pointer-events-none absolute -top-10 -right-10 h-28 w-28 rounded-full bg-[var(--Main-CTA-button,#228b22)]/10 blur-2xl"
        />
        <div
          aria-hidden
        ...
        <div className="relative mt-4 flex items-end justify-between gap-3 min-[90rem]:mt-5">
          ...
          <p
            className={`${SEGOE_UI_CLASS} text-[1.25rem] font-[700] text-[var(--Main-CTA-button,#228b22)] sm:text-[1.375rem]`}
          >
            {percent}%
          </p>
        </div>
        ...
        <div
          className="relative mt-3.5 h-2.5 w-full overflow-hidden rounded-2xl bg-[#EDE8E3] min-[90rem]:mt-4"
          role="progressbar"
        ...
        >
          <motion.div
            className="h-full rounded-2xl bg-[var(--Main-CTA-button,#228b22)]"
            initial={{ width: 0 }}
        ...
        <dl className="relative mt-4 grid grid-cols-2 gap-3 border-t border-[#E8E8E8] pt-4 min-[90rem]:mt-5 min-[90rem]:pt-5">
          <div>
            <dt
      ...
      <div className="relative mt-5 flex flex-col gap-2.5 sm:gap-3 min-[90rem]:mt-6">
        ...
        <p
          className={`${SEGOE_UI_CLASS} relative mt-2 text-center text-[0.8125rem] font-[400] text-[var(--Paragraph,#5F6D64)] min-[90rem]:mt-3`}
        >
