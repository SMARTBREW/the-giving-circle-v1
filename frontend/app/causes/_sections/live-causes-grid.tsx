...
export default function LiveCausesGrid() {
  ...
  return (
    ...
    >
      ...
      <ul className="mt-8 grid w-full grid-cols-1 gap-5 sm:mt-10 md:grid-cols-2 md:gap-5 min-[56.25rem]:grid-cols-3 min-[56.25rem]:gap-4 lg:mt-12 lg:gap-5 min-[90rem]:gap-6">
        {visible.map((cause) => (
