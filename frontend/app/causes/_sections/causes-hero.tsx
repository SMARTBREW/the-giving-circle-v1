...
export default function CausesHero() {
  ...
  return (
    <section className="relative -mt-[5.5rem] min-h-0 w-full overflow-x-hidden bg-[#F3F9FF] pt-[5.5rem] sm:-mt-[6.25rem] sm:pt-[6.25rem] md:-mt-[6.75rem] md:pt-[6.75rem] lg:-mt-[7rem] lg:pt-[7rem] min-[56.25rem]:min-h-[min(100dvh,56rem)] min-[90rem]:-mt-[7.25rem] min-[90rem]:h-dvh min-[90rem]:overflow-hidden min-[90rem]:pt-[7.25rem]">
      <div className="mx-auto flex h-full w-full max-w-[90rem] flex-col gap-6 px-4 py-6 sm:gap-8 sm:px-8 sm:py-8 md:px-10 md:py-10 min-[56.25rem]:flex-row min-[56.25rem]:items-center min-[56.25rem]:justify-between min-[56.25rem]:gap-8 min-[56.25rem]:px-10 min-[56.25rem]:py-8 lg:gap-14 lg:px-12 lg:py-10 min-[90rem]:gap-16 min-[90rem]:px-[6.25rem] min-[90rem]:py-0">
        <FadeInSection className="flex min-h-0 w-full min-w-0 flex-1 flex-col min-[56.25rem]:max-w-[48%] min-[56.25rem]:justify-between lg:max-w-[36rem] min-[90rem]:h-[38.5rem] min-[90rem]:max-w-[36rem]">
          <div className="flex flex-col">
            ...
            <div className="mt-6 flex w-full flex-col items-center gap-3 sm:mt-8 sm:flex-row sm:justify-center sm:gap-4 min-[56.25rem]:mt-6 min-[56.25rem]:justify-start min-[56.25rem]:gap-3 lg:mt-8 lg:gap-4 min-[90rem]:mt-12 min-[90rem]:gap-6">
              <CtaButton
                href={primaryCta.href}
                smoothScroll={primaryCta.href.startsWith("#")}
                className="h-12 w-full gap-2 px-6 sm:h-14 sm:w-auto sm:min-w-[11rem] sm:px-7 min-[56.25rem]:h-11 min-[56.25rem]:min-w-0 min-[56.25rem]:px-5 min-[56.25rem]:text-[0.8125rem] lg:h-12 lg:min-w-0 lg:px-6 lg:text-[0.9375rem] min-[90rem]:h-16 min-[90rem]:min-w-[16.9375rem] min-[90rem]:px-9 min-[90rem]:py-[1.125rem] min-[90rem]:text-[1.125rem]"
              ...
              <CtaButton
                ...
                variant="outline"
                className="h-12 w-full bg-[#FFFFFF] px-6 sm:h-14 sm:w-auto sm:min-w-[11rem] sm:px-7 min-[56.25rem]:h-11 min-[56.25rem]:min-w-0 min-[56.25rem]:px-5 min-[56.25rem]:text-[0.8125rem] lg:h-12 lg:min-w-0 lg:px-6 lg:text-[0.9375rem] min-[90rem]:h-16 min-[90rem]:min-w-[14rem] min-[90rem]:px-9 min-[90rem]:text-[1.125rem]"
          ...
          <ul className="mt-8 flex w-full flex-wrap items-center justify-center gap-x-6 gap-y-4 sm:mt-10 sm:gap-x-10 min-[56.25rem]:mt-8 min-[56.25rem]:flex-nowrap min-[56.25rem]:justify-start min-[56.25rem]:gap-x-5 lg:mt-8 lg:gap-x-8 min-[90rem]:mt-0 min-[90rem]:gap-14">
            {stats.map((stat) => (
              <li
                key={stat.label}
        ...
        <FadeInSection className="relative mx-auto aspect-[4/3] w-full max-w-[26rem] shrink-0 overflow-hidden rounded-[1.25rem] sm:aspect-[16/10] sm:max-w-[34rem] sm:rounded-[1.5rem] md:max-w-[40rem] min-[56.25rem]:mx-0 min-[56.25rem]:aspect-[3/4] min-[56.25rem]:h-[clamp(20rem,52dvh,34rem)] min-[56.25rem]:w-[min(42%,22rem)] min-[56.25rem]:max-w-none lg:h-[clamp(24rem,58dvh,38.5rem)] lg:w-[min(44%,28rem)] lg:aspect-auto min-[90rem]:h-[38.5rem] min-[90rem]:w-[32.125rem] min-[90rem]:rounded-[2rem]">
          <Image
            src={src}
            alt={alt}
            fill
