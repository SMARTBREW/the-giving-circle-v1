                  ...
                  {currentStep === 2 ? (
                    <>
                      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain pb-4">
                        ...
                        <p
                          className={`${SEGOE_UI_CLASS} mt-2.5 max-w-[32rem] text-[1rem] leading-7 font-[400] text-[var(--Paragraph,#4a5558)] lg:mt-3 lg:text-[1.0625rem] lg:leading-8 min-[90rem]:text-[1.125rem]`}
                        >
                          {step2.subtitle}
                        </p>
                      ...
                      {submitError ? (
                        <p
                          role="alert"
                          className={`${SEGOE_UI_CLASS} shrink-0 pb-3 text-[0.9375rem] leading-6 text-[#E62B4F]`}
                        >
                          {submitError}
                        </p>
                      ) : null}
