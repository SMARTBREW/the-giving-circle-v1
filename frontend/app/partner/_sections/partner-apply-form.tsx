...
export default function PartnerApplyForm() {
  const { title, subtitle, steps, step1, step2, thanks } = PARTNER_APPLY;
          ...
          {currentStep === 3 ? (
            <div className="flex min-h-0 flex-1 flex-col items-center justify-center bg-[#FFFFFF] px-5 py-10 sm:px-8 md:px-10 lg:px-12 min-[90rem]:px-[6.25rem]">
              <div className="flex w-full max-w-[36rem] flex-col items-center sm:max-w-[45rem] min-[90rem]:w-[51rem] min-[90rem]:max-w-[51rem]">
                ...
                <h2
                  className={`${SEGOE_UI_CLASS} mt-6 text-center text-[2.5rem] leading-none font-[700] text-[#212121] sm:text-[3rem] min-[90rem]:mt-6 min-[90rem]:h-16 min-[90rem]:text-[3rem]`}
                >
                  {thanks.title}
                </h2>

                <p
                  className={`${SEGOE_UI_CLASS} mt-6 px-2 text-center text-[1.25rem] leading-snug font-[700] tracking-[0.5px] text-[var(--Main-CTA-button,#00A3BE)] sm:text-[1.5rem] sm:leading-none min-[90rem]:h-8 min-[90rem]:px-0 min-[90rem]:text-[1.5rem]`}
                >
                  {thanks.eyebrow}
                </p>

                <p
                  className={`${SEGOE_UI_CLASS} mt-4 max-w-[32.375rem] text-center text-[1.0625rem] leading-8 font-[400] text-[#212121] sm:text-[1.125rem] sm:leading-9 min-[90rem]:text-[1.125rem] min-[90rem]:leading-9`}
                >
                  {thanks.body}
                </p>
                ...
                {currentStep === 2 ? (
                  <>
                    <div className="min-h-0 flex-1 overflow-y-auto">
                      ...
                      <p
                        className={`${SEGOE_UI_CLASS} mt-3 max-w-[32rem] text-[1rem] leading-7 font-[400] text-[var(--Paragraph,#5F6D64)] sm:text-[1.125rem] sm:leading-8`}
                      >
                        {step2.subtitle}
                      </p>
