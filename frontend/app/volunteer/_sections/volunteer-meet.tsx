...
export default function VolunteerMeet() {
  ...
  return (
    <VolunteerBand
      ...
      ctaLabel={ctaLabel}
      href={href}
      ctaClassName="h-12 w-full max-w-[17.25rem] gap-2 rounded-full border bg-[#FFFFFF] px-8 py-4 sm:h-14 min-[90rem]:h-16 min-[90rem]:w-[17.25rem] min-[90rem]:px-10 min-[90rem]:py-5"
    />
  );
}
