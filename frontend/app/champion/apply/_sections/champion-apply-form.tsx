...
const primaryBtnClass = `${SEGOE_UI_CLASS} inline-flex h-11 w-full items-center justify-center rounded-xl bg-[var(--Main-CTA-button,#00A3BE)] text-[1rem] leading-none font-[700] text-[#FFFFFF] transition-opacity disabled:cursor-not-allowed disabled:opacity-40 md:h-11 md:w-[9.75rem] md:rounded-lg lg:h-12 lg:w-[10.5rem] min-[90rem]:h-[3.75rem] min-[90rem]:w-[11.25rem] min-[90rem]:text-[1.125rem]`;
  ...
  return (
    <>
      ...
      <section className="fixed inset-0 z-10 hidden min-h-0 min-w-0 overflow-hidden bg-[#FFFFFF] md:flex">
        <aside className="flex h-full w-[min(16rem,26%)] min-w-0 shrink-0 flex-col overflow-x-hidden overflow-y-auto border-r border-[#E8E8E8] bg-[#F2FBF9] px-3.5 pt-4 pb-4 sm:px-4 lg:w-[min(18.5rem,24%)] lg:px-5 lg:pt-5 lg:pb-5 min-[90rem]:w-[30.125rem] min-[90rem]:px-16 min-[90rem]:pt-10 min-[90rem]:pb-10">
            ...
            <h1 className="mt-3 w-full min-w-0 shrink-0 font-['Georgia'] text-[1.25rem] leading-7 font-[700] tracking-normal text-[#1D2D23] lg:mt-4 lg:text-[1.375rem] lg:leading-7 min-[90rem]:mt-8 min-[90rem]:w-[15.8125rem] min-[90rem]:text-[2.125rem] min-[90rem]:leading-[2.75rem]">
              {title}
            </h1>
            <p
              className={`${SEGOE_UI_CLASS} mt-1.5 w-full min-w-0 max-w-full shrink-0 text-[0.75rem] leading-5 font-[400] text-[var(--Paragraph,#5F6D64)] lg:mt-2 lg:text-[0.8125rem] lg:leading-5 min-[90rem]:mt-3 min-[90rem]:w-[19.25rem] min-[90rem]:text-[0.9375rem] min-[90rem]:leading-7`}
            >
              {subtitle}
            </p>
                  ...
                  <li key={step.title} className="flex min-w-0 gap-2.5">
                    <div className="flex w-7 shrink-0 flex-col items-center min-[90rem]:w-8">
                      ...
                      {isLast ? null : (
                        <span
                          aria-hidden
                          className="my-1 min-h-[1.25rem] w-0 flex-1 border-l-2 border-dotted border-[#D0D5DD] min-[90rem]:min-h-[1.75rem]"
                        />
                      )}
                    </div>
                    <div
                    ...
                    >
                      ...
                      <p
                        className={`${SEGOE_UI_CLASS} mt-0.5 w-full text-[0.75rem] leading-5 font-[400] text-[var(--Paragraph,#5F6D64)] lg:text-[0.8125rem] min-[90rem]:text-[0.9375rem] min-[90rem]:leading-6`}
                      >
                        {step.description}
                      </p>
                    </div>
              ...
              <div className="flex h-full min-h-0 w-full min-w-0 flex-1 flex-col overflow-hidden bg-[#FFFFFF]">
                <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col items-center overflow-x-hidden overflow-y-auto px-5 py-5 sm:px-6 sm:py-6 lg:px-8 lg:py-6 min-[90rem]:px-[6.25rem] min-[90rem]:py-10">
                  <div className="flex w-full min-w-0 max-w-[36rem] flex-1 flex-col items-center justify-center lg:max-w-[40rem] min-[90rem]:max-w-[51rem]">
                    <span
                      className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-[var(--Brand-Green-Teal,#00A98F)] sm:h-14 sm:w-14 min-[90rem]:h-[6.25rem] min-[90rem]:w-[6.25rem]"
                      style={{
                        background:
                    ...
                    <h2
                      className={`${SEGOE_UI_CLASS} mt-3 max-w-full text-center text-[1.75rem] leading-none font-[700] text-[#212121] sm:mt-4 sm:text-[2rem] min-[90rem]:mt-6 min-[90rem]:h-16 min-[90rem]:text-[3rem]`}
                    >
                      {thanks.title}
                    </h2>
                    <p
                      className={`${SEGOE_UI_CLASS} mt-2.5 max-w-full text-center text-[1rem] leading-snug font-[700] tracking-[0.5px] text-[var(--Main-CTA-button,#00A3BE)] sm:mt-3 sm:text-[1.125rem] min-[90rem]:mt-6 min-[90rem]:h-8 min-[90rem]:text-[1.5rem] min-[90rem]:leading-none`}
                    >
                      {thanks.eyebrow}
                    </p>
                    <p
                      className={`${SEGOE_UI_CLASS} mt-2.5 max-w-[32.375rem] text-center text-[0.875rem] leading-6 font-[400] text-[#212121] sm:mt-3 sm:text-[0.9375rem] sm:leading-6 min-[90rem]:mt-4 min-[90rem]:text-[1.125rem] min-[90rem]:leading-9`}
                    >
                      {thanks.body}
                    </p>

                    <div className="mt-4 w-full min-w-0 border-t border-[#BDBDBD] pt-4 text-left sm:mt-5 sm:pt-5 min-[90rem]:mt-7 min-[90rem]:pt-[2.8125rem]">
                      <p
                        className={`${SEGOE_UI_CLASS} text-[1.0625rem] leading-none font-[600] text-[#000000] sm:text-[1.125rem] min-[90rem]:text-[1.5rem]`}
                      >
                        {thanks.inviteLabel}
                      </p>
                      <p
                        className={`${SEGOE_UI_CLASS} mt-2 max-w-full text-[0.875rem] leading-5 font-[400] text-[#212121] sm:mt-2.5 sm:text-[0.9375rem] sm:leading-6 min-[90rem]:mt-3 min-[90rem]:text-[1.125rem] min-[90rem]:leading-none`}
                      >
                        {thanks.inviteHint}
                      </p>
                      <div className="mt-3 flex h-11 w-full min-w-0 overflow-hidden rounded-xl border border-[var(--Main-CTA-button,#00A3BE)] bg-[#FFFFFF] sm:mt-4 sm:h-12 sm:rounded-2xl min-[90rem]:mt-8 min-[90rem]:h-[4.5rem] min-[90rem]:rounded-[1rem]">
                        <input
                          readOnly
                          value={thanks.inviteUrl}
                          className={`${SEGOE_UI_CLASS} w-0 min-w-0 flex-1 truncate bg-transparent px-3 text-[0.8125rem] text-[#212121] outline-none sm:px-4 sm:text-[0.9375rem] min-[90rem]:px-5 min-[90rem]:text-[1rem]`}
                        />
                        <button
                          type="button"
                          onClick={() => void handleCopy()}
                          className={`${SEGOE_UI_CLASS} inline-flex h-full shrink-0 items-center gap-1.5 bg-[var(--Main-CTA-button,#00A3BE)] px-3 text-[0.8125rem] font-[700] text-[#FFFFFF] sm:gap-2 sm:px-5 sm:text-[0.9375rem] min-[90rem]:gap-2.5 min-[90rem]:px-6 min-[90rem]:text-[1rem]`}
                        >
                          {copied ? "Copied" : thanks.copyLabel}
                        </button>
                      </div>
                      <div className="mt-4 border-t border-[#BDBDBD] sm:mt-5 min-[90rem]:mt-10" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex w-full shrink-0 justify-center bg-[#FFFFFF] px-5 pt-1 pb-4 sm:px-6 sm:pb-5 lg:px-8 min-[90rem]:px-[6.25rem] min-[90rem]:pt-2 min-[90rem]:pb-12">
                  <Link
                    ...
                    className={`${SEGOE_UI_CLASS} inline-flex items-center gap-2 text-[0.9375rem] font-[600] text-[var(--Main-CTA-button,#00A3BE)] min-[90rem]:text-[1rem]`}
                  >
                    {thanks.homeLabel}
                  ...
                  {currentStep === 3 ? (
                    <>
                      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain pb-4">
                        ...
                        <p
                          className={`${SEGOE_UI_CLASS} mt-2.5 max-w-[27.75rem] text-[1rem] leading-7 font-[400] text-[var(--Paragraph,#5F6D64)] lg:mt-3 lg:text-[1.0625rem] lg:leading-8 min-[90rem]:text-[1.125rem]`}
                        >
                          {step3.subtitle}
                        </p>
                      ...
                      {submitError ? (
                        <p
                          role="alert"
                          className={`${SEGOE_UI_CLASS} pb-5 text-[0.9375rem] leading-6 text-[#B42318]`}
                        >
                          {submitError}
                        </p>
                      ) : null}
