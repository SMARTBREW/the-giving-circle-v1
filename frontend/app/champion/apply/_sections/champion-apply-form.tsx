...
const primaryBtnClass = `${SEGOE_UI_CLASS} inline-flex h-12 w-40 items-center justify-center rounded-lg bg-[var(--Main-CTA-button,#00A3BE)] text-[1rem] leading-none font-[700] text-[#FFFFFF] transition-opacity disabled:cursor-not-allowed disabled:opacity-40 sm:h-[3.75rem] sm:w-[11.25rem] sm:text-[1.125rem]`;
...
const footerBarClass =
  "mt-auto flex w-full shrink-0 items-center justify-end gap-3 border-t border-[#BDBDBD] pt-5 pb-5 sm:gap-4";
