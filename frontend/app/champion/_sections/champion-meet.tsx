...
export default function ChampionMeet() {
  ...
  return (
    <VolunteerBand
      ...
      href={href}
      people={people}
      ctaClassName="h-12 w-full max-w-[20.875rem] gap-2 rounded-[100px] border bg-[#FFFFFF] px-8 py-4 sm:h-14 min-[90rem]:h-16 min-[90rem]:w-[20.875rem] min-[90rem]:px-10 min-[90rem]:py-5"
    />
  );
}
