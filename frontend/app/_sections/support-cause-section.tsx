...
export default function SupportCauseSection() {
  return (
    <section className="relative isolate min-h-[28rem] w-full overflow-hidden sm:min-h-[30rem] md:min-h-[32rem] lg:min-h-[30rem] min-[90rem]:h-[29.625rem] min-[90rem]:min-h-0">
      <Image
      ...
      />
      <FadeInSection className="relative z-[1] mx-auto flex h-full min-h-[28rem] w-full max-w-[90rem] flex-col items-center justify-center px-6 py-14 sm:min-h-[30rem] sm:px-10 sm:py-16 md:min-h-[32rem] md:px-12 md:py-16 lg:min-h-[30rem] lg:px-14 lg:py-16 min-[90rem]:relative min-[90rem]:block min-[90rem]:min-h-0 min-[90rem]:px-0 min-[90rem]:py-0">
